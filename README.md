...
После успешного выполнения проекта можно будет в браузере перейти на страницу проекта http://192.168.11.150:8080  
![браузер должен отобразить страницу:](/images/image1.jpg)  
